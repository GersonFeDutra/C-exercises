...
void draw_textured_cube(GLuint tex) {
...
void display(void) {
    ...
    // desenha cubo com textura
    draw_textured_cube(texId);
...
void reshape(int w, int h) {
    ...
    glLoadIdentity();
    gluPerspective(60.0, (GLfloat)w/(GLfloat)h, 0.1, 100.0); // fov, aspect, near, far
    glMatrixMode(GL_MODELVIEW);
}
